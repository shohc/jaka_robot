...
(cl:defmethod cl:initialize-instance :after ((m <SetCollision-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCollision-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaka_msgs-srv:<SetCollision-request> is deprecated: use jaka_msgs-srv:SetCollision-request instead.")))

(cl:ensure-generic-function 'is_enable-val :lambda-list '(m))
(cl:defmethod is_enable-val ((m <SetCollision-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaka_msgs-srv:is_enable-val is deprecated.  Use jaka_msgs-srv:is_enable instead.")
  (is_enable m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetCollision-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCollision-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaka_msgs-srv:<SetCollision-response> is deprecated: use jaka_msgs-srv:SetCollision-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCollision-response>)))
  ...
  "jaka_msgs/SetCollisionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCollision-response)))
  "Returns string type for a service object of type 'SetCollision-response"
  "jaka_msgs/SetCollisionResponse")
