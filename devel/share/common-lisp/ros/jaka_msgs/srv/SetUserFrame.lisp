...
(cl:defmethod cl:initialize-instance :after ((m <SetUserFrame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetUserFrame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaka_msgs-srv:<SetUserFrame-request> is deprecated: use jaka_msgs-srv:SetUserFrame-request instead.")))
...
(cl:defmethod user_num-val ((m <SetUserFrame-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaka_msgs-srv:user_num-val is deprecated.  Use jaka_msgs-srv:user_num instead.")
  (user_num m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetUserFrame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetUserFrame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaka_msgs-srv:<SetUserFrame-response> is deprecated: use jaka_msgs-srv:SetUserFrame-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetUserFrame-response>)))
  ...
  "jaka_msgs/SetUserFrameResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetUserFrame-response)))
  "Returns string type for a service object of type 'SetUserFrame-response"
  "jaka_msgs/SetUserFrameResponse")
