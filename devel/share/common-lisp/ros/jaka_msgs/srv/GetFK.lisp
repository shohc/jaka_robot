...
(cl:defmethod cl:initialize-instance :after ((m <GetFK-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetFK-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaka_msgs-srv:<GetFK-request> is deprecated: use jaka_msgs-srv:GetFK-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetFK-request>)))
  ...
  "10d9bfd5c1accf4678c49f520f9480b8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetFK-request)))
  "Returns md5sum for a message object of type 'GetFK-request"
  "10d9bfd5c1accf4678c49f520f9480b8")
...
(cl:defmethod cl:initialize-instance :after ((m <GetFK-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetFK-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaka_msgs-srv:<GetFK-response> is deprecated: use jaka_msgs-srv:GetFK-response instead.")))

(cl:ensure-generic-function 'cartesian_pose-val :lambda-list '(m))
(cl:defmethod cartesian_pose-val ((m <GetFK-response>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetFK-response>)))
  ...
  (cl:format cl:nil "~%float32[] cartesian_pose~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetFK-response)))
  "Returns full string definition for message of type 'GetFK-response"
  (cl:format cl:nil "~%float32[] cartesian_pose~%string message~%~%~%"))
